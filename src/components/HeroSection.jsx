    ...
    <section className="heroSection">
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-100px w-full">
            <div className="col-1">
                ...
                <p className="heroText text-xl">Our digital marketing agency helps businesses grow and succeed online through a range of services including SEO, PPC, social media marketing, and content creation.</p>
                <button className="consultBtn  bg-black text-white text-20px">
                    Book a consultation
                </button>
            </div>
            <div>
